...
const AccessibilityHeroSection: React.FC = () => {
    return (
        <section className="relative w-full pt-8 pb-16 px-8 md:px-12 lg:px-24 overflow-hidden bg-gradient-to-br from-brand-blue to-indigo-900 text-white">
    ...
    >
                            <button
                                ...
                                className="px-8 py-4 bg-white text-brand-blue font-bold rounded-2xl shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer"
                            >
