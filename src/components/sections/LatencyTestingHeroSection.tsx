  ...
  return (
    <section className="relative pt-8 pb-16 px-8 md:px-12 lg:px-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        {/* Breadcrumb */}
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-6">
          <Link
            href="/"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-5">
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              As an{" "}
              <Link href="/about-us" className="text-brand-blue underline hover:no-underline decoration-brand-blue font-medium">
              ...
              <span className="font-semibold text-brand-blue">
                <Link href="/qa-documentation-services" className="underline hover:no-underline decoration-brand-blue">
                  ISO 29119 standards
                </Link>
              </span>{" "}
            ...
            <div className="flex flex-col items-center lg:items-start sm:flex-row gap-4">
              ...
              <button
                ...
                className="border-2 cursor-pointer border-brand-blue text-brand-blue px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 transition-colors duration-300 flex items-center justify-center min-h-[48px]"
              >
            ...
            <div className="grid grid-cols-2 xl:grid-cols-4 gap-6 pt-8">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-700 font-medium">Target P95 Latency</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-green-700">
                  99.9%
                </div>
                <div className="text-sm text-gray-700 font-medium">Uptime Achieved</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-purple-700">
                  500+
                </div>
                <div className="text-sm text-gray-700 font-medium">Apps Optimized</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-orange-700">
                  85%
                </div>
                <div className="text-sm text-gray-700 font-medium">Latency Reduced</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            <div className="bg-gray-900 rounded-2xl p-6 shadow-2xl border border-gray-700">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-xs text-gray-300 font-mono">latency-monitor.testriq.com</span>
              </div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div>
                  ...
                  <div className="h-2 bg-gray-700 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-blue-400 to-blue-500 rounded-full" style={{ width: "28%" }} />
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-xs text-gray-300 mb-1">
                  ...
                  <div className="h-2 bg-gray-700 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-full" style={{ width: "55%" }} />
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-xs text-gray-300 mb-1">
                    <span>TTFB (Server)</span>
                    <span className="text-orange-300 font-semibold">89ms</span>
                  </div>
                  <div className="h-2 bg-gray-700 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-orange-400 to-orange-500 rounded-full" style={{ width: "78%" }} />
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-xs text-gray-300 mb-1">
                    <span>Content Transfer</span>
                    <span className="text-red-400 font-semibold">134ms</span>
                  </div>
                  <div className="h-2 bg-gray-700 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-red-400 to-red-500 rounded-full" style={{ width: "92%" }} />
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-gray-800 rounded-lg p-3 text-center border border-gray-700">
                  <div className="text-xs font-bold text-green-400 font-mono">P50</div>
                  <div className="text-xl font-bold text-white font-mono">42ms</div>
                </div>
                <div className="bg-gray-800 rounded-lg p-3 text-center border border-gray-700">
                  <div className="text-xs font-bold text-yellow-300 font-mono">P95</div>
                  <div className="text-xl font-bold text-white font-mono">89ms</div>
                </div>
                <div className="bg-gray-800 rounded-lg p-3 text-center border border-gray-700">
                  <div className="text-xs font-bold text-red-400 font-mono">P99</div>
