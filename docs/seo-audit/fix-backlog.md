...
| T-6 | Crawl / 404 | GSC "Not found (404)" = **551 URLs** | Google crawling 551 dead URLs → crawl waste + quality drag | Export list from GSC → 301 the good ones to live targets, remove internal-link/sitemap refs to truly-dead ones | P1 | 🟡 2 internal broken links fixed; rest ⛔ needs 404 export |
